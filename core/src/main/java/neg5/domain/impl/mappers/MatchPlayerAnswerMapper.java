...
@Singleton
public class MatchPlayerAnswerMapper
        extends AbstractObjectMapper<MatchPlayerAnswer, MatchPlayerAnswerDTO> {
    ...
    @Override
    public MatchPlayerAnswer mergeToEntity(
            MatchPlayerAnswerDTO matchPlayerAnswerDTO, MatchPlayerAnswer matchPlayerAnswer) {
    ...
    protected void enrichDTO(
        ...
        if (matchPlayerAnswer.getTournamentTossupValue() != null) {
            matchPlayerAnswerDTO.setAnswerType(
                    matchPlayerAnswer.getTournamentTossupValue().getAnswerType());
        }
    }
