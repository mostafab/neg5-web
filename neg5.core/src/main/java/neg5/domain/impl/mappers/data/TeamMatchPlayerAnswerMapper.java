...
@Singleton
public class TeamMatchPlayerAnswerMapper
        extends AbstractObjectMapper<TeamMatchPlayerAnswer, MatchPlayerAnswerDTO> {
    ...
    protected void enrichDTO(
            MatchPlayerAnswerDTO matchPlayerAnswerDTO,
            TeamMatchPlayerAnswer teamMatchPlayerAnswer) {
